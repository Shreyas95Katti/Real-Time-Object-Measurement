                    ...
                    if corners:
                        ...
                        for contour in contours:
                            ...
                            if area > 2500:                 #The contours/edges of objects will be drawn only if their area is above 2500
                                ...
                                cv2.putText(img,"Width : {}cm".format(round(wide,2)),(int(x+135),int(y - 15)), cv2.FONT_HERSHEY_PLAIN,3,(0,0,100),3)
                                cv2.putText(img,"Height : {}cm".format(round(tall,2)),(int(x+135),int(y - 100)), cv2.FONT_HERSHEY_PLAIN,3,(0,0,100),3)
                                Frame.image(img)
                    ...
                    if corners:
                        ...
                        if detected_circles is not None:
                            ...
                            for pt in detected_circles[0, :]:
                                    ...
                                    cv2.putText(img,"Radius : {}cm".format(round(r,2)),org =(900,300), fontFace = cv2.FONT_HERSHEY_PLAIN,fontScale = 3,color = (100,0,0),thickness = 2)
